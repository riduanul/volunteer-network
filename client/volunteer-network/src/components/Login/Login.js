...
const handleGoogleLogin = () => {
    ...
    return (
        <div >
            ...
            <h4>Login with</h4>
            <div>
                <button onClick={handleGoogleLogin} className='login-btn'><span><img src={googleLogo} alt="img"width="18"/></span>  Login with google</button> <br/>
                <small>  Don't have any account? <Link to="/register">Create account</Link> </small> 
